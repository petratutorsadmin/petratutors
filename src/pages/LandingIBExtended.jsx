...
const LandingIBExtended = () => {
  const { t } = useTranslation();
  const ns = 'landing_ib_ext';
  ...
  return (
    <div className={styles.container}>
      <SEO
        ...
        description="IB内部評価（IA）・課題論文（EE）・TOKエッセイに特化した個別指導。IB DP経験のバイリンガル講師がRQ設定から最終提出まで伴走。東京・全国オンライン対応。入会金なし。"
        path="/ib-ia-ee-tok"
      />
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.groupDiscountContainer}>
            <span className={styles.groupDiscount}>
              <MapPin size={14} /> IB IA · EE · TOK · 東京 · オンライン全国
            </span>
          </div>
...
export default LandingIBExtended;
