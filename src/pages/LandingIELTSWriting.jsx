...
const LandingIELTSWriting = () => {
  const { t } = useTranslation();
  const ns = 'landing_ielts_w';
  ...
  return (
    <div className={styles.container}>
      <SEO
        ...
        description="IELTSライティング（Task 1・Task 2）に特化した完全1:1個別指導。バイリンガル講師が毎回フルエッセイを添削。バンド6.0→7.0以上を目指す。オンライン全国対応。入会金なし。"
        path="/ielts-writing"
      />
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.groupDiscountContainer}>
            <span className={styles.groupDiscount}>
              <MapPin size={14} /> Task 1 · Task 2 · 毎回添削 · オンライン全国
            </span>
          </div>
...
export default LandingIELTSWriting;
