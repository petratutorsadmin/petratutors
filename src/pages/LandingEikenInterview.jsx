...
const LandingEikenInterview = () => {
  const { t } = useTranslation();
  const ns = 'landing_eiken_itv';
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.groupDiscountContainer}>
            <span className={styles.groupDiscount}>
              <MapPin size={14} /> 英検2級 二次試験 · 模擬面接 · オンライン全国
            </span>
          </div>
...
export default LandingEikenInterview;
