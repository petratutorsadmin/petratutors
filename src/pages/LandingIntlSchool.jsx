...
const LandingIntlSchool = () => {
  const { t } = useTranslation();
  const ns = 'landing_intl';
  ...
  return (
    <div className={styles.container}>
      <SEO
        ...
        description="東京のインターナショナルスクール生向け家庭教師。IB DP/MYP/PYP・英語で学ぶ数学・科学・英語科目を個別サポート。バイリンガル講師対応。入会金なし。"
        path="/international-school-tutor"
      />
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.groupDiscountContainer}>
            <span className={styles.groupDiscount}>
              <MapPin size={14} /> インター校対応 · IB DP/MYP/PYP · 東京 · オンライン全国
            </span>
          </div>
...
export default LandingIntlSchool;
