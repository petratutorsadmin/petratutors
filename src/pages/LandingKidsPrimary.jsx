...
const LandingKidsPrimary = () => {
  const { t } = useTranslation();
  const ns = 'landing_kids_prim';
  ...
  return (
    <div className={styles.container}>
      <SEO
        ...
        description="英語が苦手な小学生向けの完全1:1個別指導。フォニックス・基礎英語・英会話を楽しく丁寧に指導。東京・全国オンライン対応。入会金なし。無料体験あり。"
        path="/kids-english-primary"
      />
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.groupDiscountContainer}>
            <span className={styles.groupDiscount}>
              <MapPin size={14} /> 小1〜小6 · フォニックスから · 笹塚 対面 · オンライン全国
            </span>
          </div>
...
export default LandingKidsPrimary;
