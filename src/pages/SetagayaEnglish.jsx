...
const SetagayaEnglish = () => {
  const { t } = useTranslation();
  const ns = 'landing_setagaya';
  ...
  return (
    <div className={styles.container}>
      <SEO
        ...
        description="世田谷区の英語個別指導。英検・IELTS・IB・小学生英語まで対応のバイリンガル1:1家庭教師。入会金なし。オンライン対応。無料30分体験レッスンあり。"
        path="/setagaya-english"
      />
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.groupDiscountContainer}>
            <span className={styles.groupDiscount}>
              <MapPin size={14} /> 世田谷区 · オンライン対応 · 英検・IELTS・IB
            </span>
          </div>
...
export default SetagayaEnglish;
