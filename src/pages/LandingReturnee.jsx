...
const LandingReturnee = () => {
  const { t } = useTranslation();
  const ns = 'landing_returnee';
  ...
  return (
    <div className={styles.container}>
      <SEO
        ...
        description="帰国子女の英語力維持・強化・帰国受験対策に特化した個別指導。海外在住経験のあるバイリンガル講師が担当。東京・全国オンライン対応。入会金なし。"
        path="/returnee-english"
      />
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.groupDiscountContainer}>
            <span className={styles.groupDiscount}>
              <MapPin size={14} /> 帰国子女 英語維持 · 帰国受験対策 · 東京 · オンライン全国
            </span>
          </div>
...
export default LandingReturnee;
