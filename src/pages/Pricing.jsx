    ...
    return (
        <>
            ...
            <div className="section container">
                ...
                {/* 5. MICRO COPY */}
                <Reveal y={20}>
                    <div className={`${styles.microCopy} text-center`}>
                ...
                <Reveal y={40}>
                    <div className={`${styles.continuitySection} card`}>
                ...
                {/* 8. NOTICE BOX */}
                <Reveal y={30}>
                    <div className={`${styles.noticeBox}`} style={{ marginTop: '4rem' }}>
                ...
                {/* 9. FINAL CTA (URGENCY) */}
                <Reveal y={40}>
                    <div className={`${styles.finalUrgency} text-center`}>
