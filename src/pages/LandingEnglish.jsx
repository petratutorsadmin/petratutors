...
const CONTENT = {
    ...
    ja: {
        ...
        painNote: '英語が伸び悩む原因のほとんどは、努力量ではなく「方法」にあります。',
        ...
        solutions: [
            ...
            { badge: '02', title: 'バイリンガル講師だからわかる「詰まりポイント」', desc: '日本語と英語の両方を熟知した講師が、日本語話者が英語でつまずく場所を正確に理解してサポートします。' },
        ...
        why: [
            { title: 'バイリンガルだから「言語の壁」を理解している', desc: '日本語と英語の両方で育った講師が多く、日本人学習者が英語でつまずく理由を体感として知っています。' },
